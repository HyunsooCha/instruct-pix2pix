...
SAVE_DIR=/home/hyunsoocha/GitHub/IMavatar/data/experiments/youtuber/naive_human_fewshot/hyunsoo_1/eval/hyunsoo_4/epoch_250/blond_hair
mkdir -p $SAVE_DIR
SEED=100
CFG_TXT=7.5
CFG_IMG=2.5
device=0
PROMPT="make him have blond hair"
total_frames=950
cd ..
