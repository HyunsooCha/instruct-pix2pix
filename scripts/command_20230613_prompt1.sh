...
SAVE_DIR=/home/hyunsoocha/GitHub/IMavatar/data/experiments/youtuber/naive_human_fewshot/hyunsoo_1/eval/hyunsoo_4/epoch_250/straw_hat
mkdir -p $SAVE_DIR
SEED=100
CFG_TXT=7.5
CFG_IMG=3.3
device=1
PROMPT="put a straw hat on him"
total_frames=950
cd ..
